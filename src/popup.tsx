...
function IndexPopup() {
  ...
  return (
    ...
    //   <CountButton />
    // </div>
    <div className="popup plasmo-min-w-[320px]">
      <nav>
      ...
      {!leetcodeProblemSolved && !hyperTortureMode && (
        <>
          <h2 id="unsolved-message bg-rose-600">{unsolvedMessage}</h2>

          <div className="leetcode-info plasmo-text-rose-500">
